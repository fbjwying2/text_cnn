...
tf.app.flags.DEFINE_string("traning_data_path","../data/weixin_8_title_data.txt","path of traning data.")
tf.app.flags.DEFINE_integer("vocab_size",100000,"maximum vocab size.")

#tf.app.flags.DEFINE_string("cache_file_h5py","E:/ieee_zhihu_cup/src/data.h5","path of training/validation/test data.") #../data/sample_multiple_label.txt
#tf.app.flags.DEFINE_string("cache_file_pickle","E:/ieee_zhihu_cup/src/vocab_label.pik","path of vocabulary and label files") #../data/sample_multiple_label.txt
...
def main(_):
    ...
    word2index, vocabulary_index2word, label2index, _= create_vocabulary(FLAGS.traning_data_path,FLAGS.vocab_size,name_scope=FLAGS.name_scope)
    ...
    train, test, vaild= load_data_multilabel(FLAGS.traning_data_path,word2index, label2index,FLAGS.sentence_len)
    trainX, trainY = train
    testX, testY = test
    vaildX, vaildY = vaild
